...
include "../connection/config.php"; // Adjusted path
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->num_rows > 0) {
        ...
        if ($stmt->num_rows > 0) {
            ...
            echo "Preparing to insert: $name, $email, [hashed_password], $role<br>";
            if ($stmt->execute()) {
                // echo "Insert successful! Check your database.<br>";
                echo "<script>alert('You have been successfully registered.'); window.location.href='sign_in.php';</script>";
                exit();
            } else {
